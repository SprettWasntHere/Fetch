...
3. Open your terminal in the folder mentioned above and run the following command: `pyinstaller --onefile --console --add-binary "ffmpeg.exe;." --add-binary "ffprobe.exe;." fetch.py`
4. Done
